# Bảng ước lượng thời gian công việc

Giả định: 1 ngày = 8 giờ làm việc. Thời gian ước lượng đã xét độ phức tạp kỹ thuật, quy tắc PERT/điểm chức năng/GEF theo skill ước lượng thời gian và dự phòng rủi ro từ `thông_tin_rui_ro_dự_án.md`. Dự án được lập để hoàn thành trong 5 tháng bằng cách chạy song song các nhóm AI, Backend và Frontend sau giai đoạn phân tích - thiết kế.
...
## Tổng hợp dự phòng rủi ro

| Rủi ro chính | Chi phí thời gian trong file rủi ro | Cách đưa vào ước lượng |
|---|---:|---|
| Thay đổi yêu cầu hoặc chuẩn CWE | 48 giờ / 6 ngày | Phân bổ vào A, B, C, AA |
| Sandbox sập hoặc cạn tài nguyên | 16 giờ / 2 ngày | Phân bổ vào N, T, X |
| Mô hình AI chậm hoặc sai | 24 giờ / 3 ngày | Phân bổ vào G, H, I, J, O, U |
| Mất đồng bộ mã nguồn qua WebSocket | 12 giờ / 1.5 ngày | Phân bổ vào M, S, W |
| Xung đột tích hợp Frontend, Backend, AI | 10 giờ / 1.25 ngày | Phân bổ vào O, W, Y |
| Rủi ro nhân sự và ước lượng sai | 24 giờ / 3 ngày | Giữ làm buffer trong lịch biểu 5 tháng |
